 ...
 *
 * @brief    This file contains The Startup code of STM32f407xx.
*/

#define VECTOR_TABLE_SIZE 16

typedef unsigned int  uint32_t;


extern uint32_t _estack, etext, _sbss, _edata ,_erodata;
